// Connects to the standalone mock-jira-mcp-server (in ../../mcp-jira-server)
// over stdio using the MCP SDK client, and exposes plain async functions the
// rest of the backend can call without knowing anything about MCP.
